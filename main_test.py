...
def main(_):
    ...
    if lapt_book:
        ...
        run_CLRH(source_domain="laptop", target_domain="book", year_source=2014, year_target=2019,
                 ...
                 l2_dis=0.011, l2_f=0.001, balance_lambda=0.6, write_result=write_result)
    if book_rest:
    ...
    if book_lapt:
        ...
        run_CLRH(source_domain="book", target_domain="laptop", year_source=2019, year_target=2014,
                 learning_rate_dis=0.03, learning_rate_f=0.005, keep_prob=0.3, momentum_dis=0.80, momentum_f=0.8,
                 l2_dis=0.01, l2_f=0.001, balance_lambda=1.1, write_result=write_result)

...
count_sentences = 0
with open(temp_path + "temp/BERT_base_" + str(FLAGS.source_domain) + "embedding.txt", 'w', encoding='utf-8') as outf:
...
count_sentences = 0
with open(temp_path + "temp/BERT_base_" + str(FLAGS.source_domain) + "embedding_withCLS_SEP.txt", 'w') as outf:
    for tfname in temp_filenames_base:
        print(tfname)
        with open(tfname, 'r', encoding='utf-8') as infile:
            for line in infile:
...
unique_words = []
unique_words_index = []
with open(temp_path + "temp/BERT_base_" + str(FLAGS.source_domain) + "embedding_withCLS_SEP.txt") as BERTemb_sep:
...
counter = 0
uniqueVocaBERT = []
with open(temp_path + "temp/BERT_base_" + str(FLAGS.source_domain) + "embedding.txt", 'r', encoding='utf-8') as BERTemb:
...
lines_1 = open(temp_path + "temp/" + "unique" + str(FLAGS.source_year) + "_BERT_Data_1.txt",  'r', encoding='utf-8').readlines()
lines_2 = open(temp_path + "temp/" + "unique" + str(FLAGS.source_year) + "_BERT_Data_2.txt",  'r', encoding='utf-8').readlines()
lines_3 = open(temp_path + "temp/" + "unique" + str(FLAGS.source_year) + "_BERT_Data_3.txt",  'r', encoding='utf-8').readlines()
lines_4 = open(temp_path + "temp/" + "unique" + str(FLAGS.source_year) + "_BERT_Data_4.txt",  'r', encoding='utf-8').readlines()
...
if split:
    ...
    if domain == "laptop":
        ...
        # Restaurant train has 10806 aspects (1080 lines).
        train_lines = 10800
        split_size = 360
    elif domain == "book":

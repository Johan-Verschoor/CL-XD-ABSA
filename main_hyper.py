...
def run_hyper(source_domain, source_year, target_domain, target_year, batch_size_src, batch_size_tar, batch_size_te,
    ...
    CLRH_space = [
        ...
        hp.choice('momentum_dis', [0.85]),
        hp.choice('momentum_f', [0.80]),
        hp.choice('l2_dis', [0.01]),
        hp.choice('l2_f', [0.001]),
        hp.choice('balance_lambda', [0.6]),
        hp.choice('tau_d', [0.05, 0.07, 0.1, 0.2]),
        hp.choice('tau_c', [0.05, 0.07, 0.1, 0.2]),
